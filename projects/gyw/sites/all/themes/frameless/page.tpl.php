    ...
    <div id="header"><div class="section clearfix">
      ...
      <?php if ($site_name || $site_slogan): ?>
        <div id="name-and-slogan">
          ...
          <?php if ($site_slogan): ?>
            <div id="sub_head"><?php print $site_slogan; ?></div>
          <?php endif; ?>
        </div> <!-- /#name-and-slogan -->
      <?php endif; ?>
      ...
      <script src="https://use.typekit.net/zbq5ydu.js"></script>
      <script>try{Typekit.load({ async: true });}catch(e){}</script>
    </div></div> <!-- /.section, /#header -->

    <?php if ($main_menu || $secondary_menu): ?>
      <a class="mobile-menu-opt" href="#" onclick="displayMob();"> MENU </a>
      <nav id="navigation" class="hide"><div class="section">
